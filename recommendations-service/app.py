...
async def predict(user_id):
    ...
    """
    request = requests.post('https://7b3svgj3y7.execute-api.us-east-1.amazonaws.com/', json={'query': query, 'variables': {'user_id': int(user_id)}})
...
if __name__ == '__main__':
    app.run(debug=True, host="0.0.0.0", port=os.environ.get("PORT", default=5000))